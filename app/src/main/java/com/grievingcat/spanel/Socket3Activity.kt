...
class Socket3Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding = ActivitySocket3Binding.inflate(layoutInflater)
        setContentView(binding.root)
        binding.bnav3.itemIconTintList = null
        replaceFragment(powerfragment)
        binding.bnav3.setOnItemSelectedListener {
            when(it.itemId){
